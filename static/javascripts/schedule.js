...
yesButton.addEventListener('click',deleteTraining)
noButton.addEventListener('click', closeMessage)

//training click
function selectTraining(t){
    resetTraining()
    let trainingColor = window.getComputedStyle(t.target).backgroundColor
...
function resetTraining(){
    const cancelTraining = document.querySelectorAll('.trainingType')
